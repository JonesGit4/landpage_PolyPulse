    ...
    <section id="performance" className="py-28 relative">
      ...
      <Container>
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 mb-4"><div className="live-dot" /><span className="text-sm text-secondary font-mono font-medium tracking-wide">LIVE</span></div>
        ...
        <div className="card-base p-6 sm:p-8 neon-border">
          ...
          <svg viewBox="0 0 800 180" className="w-full h-36">
            <defs><linearGradient id="chartGrad" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#00D4FF" stopOpacity="0.25" /><stop offset="100%" stopColor="#00D4FF" stopOpacity="0" /></linearGradient></defs>
