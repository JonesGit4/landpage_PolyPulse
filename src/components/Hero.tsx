...
export default function Hero({ dict }: HeroProps) {
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 bg-grid overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-16 text-center">
        {/* Badge */}
        ...
        {/* Headline */}
        <h1 className="text-5xl sm:text-6xl lg:text-[5.5rem] leading-[1.05] font-heading font-extrabold text-white mb-6">
          {dict.hero.headline}{' '}
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-20">
          <a href="#pricing" className="group px-8 py-4 bg-gradient-to-r from-primary to-secondary text-dark-900 font-bold text-lg rounded-full hover:shadow-[0_0_30px_rgba(0,212,255,0.4)] transition-all duration-300 hover:scale-105">
            {dict.hero.cta1}
          </a>
